...
import {ChatDataService, ConfigurationService, HistoryTitleService} from "../../user_anything/data-services";
import {NzNotificationService} from "ng-zorro-antd/notification";
import {ContextMemoryService, SidebarService, SizeReportService} from "../../user_anything/services";
import {ShowTypeService} from "../../user_anything/services";
import {ModelFetchService} from "../../user_anything/services";
import {ChatContextHandler, VisionContextHandler} from "../../user_anything/handlers";
import {ChatContext, SystemContext} from "../../user_anything/services";
...
import {OpenaiService} from "../../user_anything/fetch_services";
import {backChatHistorySubject, chatSessionSubject, configurationChangeSubject} from "../../user_anything/injection_tokens";
import {contextMemoryToken, lastSessionToken, sideBarToken, sizeReportToken} from "../../user_anything/injection_tokens";
import {TranslateModule} from "@ngx-translate/core";
import {TurboService} from "../../user_anything/fetch_services/turbo.service";
import {
  AssistantRole,
  ChatHistoryModel, ChatHistoryTitle,
  ChatModel,
  ChatPacket,
  ChatVisionPacket, Configuration, FileInChat,
  ImagePacket, LastSessionModel,
  SpeechPacket, SystemPromptItem, SystemRole, TranscriptionPacket, UserRole
} from "../../user_anything/models";
import {TaskType, UserTask} from "../../user_anything/models/operations";
import { RequestType } from '../../user_anything/models/enumerates';
@Component({
